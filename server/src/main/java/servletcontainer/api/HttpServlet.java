...
public interface HttpServlet {
    ...
    default void dispatchRequest(HttpServletRequest req, HttpServletResponse resp) {
    ...
    default void doGet(HttpServletRequest req, HttpServletResponse resp) {
        throw new UnsupportedOperationException("GET not supported");
    }

    default void doPost(HttpServletRequest req, HttpServletResponse resp) {
        throw new UnsupportedOperationException("POST not supported");
    }

    default void doPut(HttpServletRequest req, HttpServletResponse resp) {
        throw new UnsupportedOperationException("PUT not supported");
    }

    default void doDelete(HttpServletRequest req, HttpServletResponse resp) {
